<?php
session_start();
require_once('../dashbord/db_connect.php');
?>
                                ...
                                <div class="col-lg-4 col-md-6 pitem">
                                    <div class="speaker-box">
                                        <div class="speaker-thumb">
                                            <img src="../dashbord/uploads/works/<?= $work['work_image']?>" width="200" height="200" alt="img">
                                        </div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="contact-form">
                                ...
                                unset($_SESSION['sent']);
                                ?>
                                <form action="../dashbord/message.php" method="POST">
